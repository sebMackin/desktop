...
namespace Purplecs.Modules.RaceScore
{
    ...
    /// 
    /// Because the control inherits from RaceScoreModuleBase you have access to any custom properties
    /// defined there, as well as properties from DNN such as PortalId, ModuleId, TabId, UserId and many more.
    /// 
    /// </summary>
    /// -----------------------------------------------------------------------------
    public partial class View : RaceScoreModuleBase, IActionable
    {
        ...
        public ModuleActionCollection ModuleActions
        {
            get
            {
                var actions = new ModuleActionCollection
                    {
                        {
                            GetNextActionID(),  "Manage Race" , "", "", "",
                           EditUrl(string.Empty, string.Empty, "Race",""), false, SecurityAccessLevel.Edit, true, false
                        },
                         {
